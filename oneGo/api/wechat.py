...
#     appid = 'wx59db66f52fa1bcbc'
#     appsecret = 'd4ed357b1a8ee67f4874e482ab638da7'
#     try:
...
#                     import requests
#                     r = requests.Session()
#                     token= r.get('https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid={}&secret={}'.format(appid,appsecret)).json()['access_token']
