function one(){$.post('http://www.yushifamily.club/session_test',function (data) {
    // console.log('+++++++++++++++++++++++'+data)
...
function username() {
        $.post('http://www.yushifamily.club/username' , function (data) {
    ...
    function userhistory() {
        ...
        $.post('http://www.yushifamily.club/UserHistory' ,{search:search},function (data) {
    ...
    req = {caseId:json_data.data[r].id};
        $.post('http://www.yushifamily.club/deleteHistory' , req,function (data) {
            userhistory()
        })
    }
    ...
    function reqJson() {
        ...
        if ($('#selected option:selected').val() == '2') {
            ...
            //发送异步请求
            $.post('http://www.yushifamily.club/reqJson', req, function (data) {
        ...
        //    如果为get请求时-----
            ...
            //发送请求
            $.post('http://www.yushifamily.club/reqJson', get_req, function (data) {
                userhistory();
                var json_response = JSON.parse(data);
                var str_rep = formatJson(json_response.data)
                document.getElementById('response_text').innerHTML = '<pre>' + str_rep + '<pre/>';
    ...
    function SaveTestCase(){
        ...
        if($('input[name="name1"]:checked').val() == 'post'){
            ...
            if(typeof(key)=='object' && typeof(value)=='object'){
                ...
                $.post('http://www.yushifamily.club/SaveTestCase', req , function (data){

                });
            }else{
                $.post('http://www.yushifamily.club/SaveTestCase', {url:url,key:key,value:value,type:'post'}, function (data){
            ...
            if(typeof(key)=='object' && typeof(value)=='object'){
                ...
                $.post('http://www.yushifamily.club/SaveTestCase', {url:url,key:key,value:value,type:'get'}, function (data){
...
function openAdd(){
        ...
        ,shadeClose:true
         ,success: function(layero,index){
              ...
              $.post('http://www.yushifamily.club/queryForProduct',{},function (data) {
                  var _html,json_data;
