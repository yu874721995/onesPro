    ...
    if(name == 'cp'){
        ...
        parent.layer.prompt({
              ...
              area: ['800px', '350px'] //自定义文本域宽高
                 ...
                 $.post('https://yushifamily.club/addChoice',{cpname:value,type:1},function(data){
            ...
            parent.layer.open({
                ...
                , yes: function (index, layero) {
                    ...
                    $.post('https://yushifamily.club/addChoice', {cpname: cpname,subjection:subjection,type: 2}, function (data) {
                        repjson = JSON.parse(data)
                        if (repjson.status == 1) {
                            parent.layer.close(index);
                        } else {
